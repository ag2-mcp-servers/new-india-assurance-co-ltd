...
#   timestamp: 2025-06-28T15:15:26+00:00
...
class CertificateParameters(BaseModel):
    ...
    UDF1: str = Field(
        ..., description='Policy Number', examples=['1301002334568097565']
    )
    UDF2: str = Field(..., description='Customer Id', examples=['PO98765432'])
    UDF3: str = Field(..., description='Policy Start Date', examples=['DD/MM/YYYY'])
